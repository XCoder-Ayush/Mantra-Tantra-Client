    ...
    const fetchData = async () => {
      try {
        const testimonialResponse = await fetch(
          `${process.env.REACT_APP_SERVER_URL}/api/v1/testimonial`,
        );
    ...
    <div className="testimonials-div">
      ...
      <div className="faq-main-div editor">
        <div className="testimonials-child1-div ">
          <p>
            Thanks to all of your encouraging emails, the inspiration to the
            Mantralekhan.com team is awesome. We regularly receive emails on how
            this website is being useful to satsangi users. Here’s some of the
